...
--
-- Host: localhost
-- Generation Time: Jan 25, 2023 at 11:08 AM
...
--
-- Database: `a_learning_based_poi_recommendation`
--
CREATE DATABASE IF NOT EXISTS `a_learning_based_poi_recommendation` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `a_learning_based_poi_recommendation`;
...
('d5rs8dzuk9pkns9uztpwmmosghx3e22j', 'eyJ1c2VyaWQiOjF9:1pKaLi:PIqnFaZhEbdHm2ZKC3SJtsIiyjg3OA7ivoixvJzkJ9Q', '2023-02-08 07:37:38.468458'),
...
('xcvbtcqz503k2ttzgzlxp90cixni2s2x', 'eyJ1c2VyaWQiOjF9:1pKcfp:pwqwNlBXJQ5Pq1IdbEs_Zns917KeIMUgQ10Rz1vqAeo', '2023-02-08 10:06:33.808030'),
('xqsz4obl70vz50d256ao8brvhadwhnln', 'eyJ1c2VyaWQiOjJ9:1pKdYO:Q8mRKWVcIIQx7TeHX4lRQnHWwCFcu0aFzX72_q7I7Ak', '2023-02-08 11:02:56.026795'),
...
(1, 'Mukesh', 'Mukesh123@gmail.com', 'Mukesh', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male'),
(2, 'Manjunath', 'tmksmanju13@gmail.com', 'Manjunath', '9535866270', 'India', 'Karnataka', 'Bangalore', '#8928,4th Cross,Rajajinagar', 'Male');
...
(27, 'Extra Tree Classifier', '53.87755102040816'),
(28, 'SVM', '47.95918367346938'),
(29, 'Logistic Regression', '48.16326530612245'),
(30, 'Recurrent Neural Network (RNN)', '48.97959183673469');
...
(9, 'POI Not Recommended', '60.0'),
(10, 'POI Recommended', '40.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_poi_recommendation`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_poi_recommendation` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `pid` varchar(300) NOT NULL,
  `point_name` varchar(30000) NOT NULL,
  `latitude_radian` varchar(300) NOT NULL,
  `longitude_radian` varchar(300) NOT NULL,
  `num_links` varchar(300) NOT NULL,
  `point_links` varchar(300) NOT NULL,
  `num_categories` varchar(300) NOT NULL,
  `categories` varchar(30000) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=6 ;

--
-- Dumping data for table `remote_user_predict_poi_recommendation`
--

INSERT INTO `remote_user_predict_poi_recommendation` (`id`, `pid`, `point_name`, `latitude_radian`, `longitude_radian`, `num_links`, `point_links`, `num_categories`, `categories`, `Prediction`) VALUES
(1, '172.217.10.238-10.42.0.151-443-55547-6', 'NAWAE DISTRICT', '-0.112259577', '2.562597128', '7', 'Papua New Guinea; Boana; Time in Australia; Morobe Province; Districts and LLGs of Papua New Guinea; Provinces of Papua New Guinea; Languages of Papua New Guinea', '2', 'MOROBE PROVINCE; DISTRICTS OF PAPUA NEW GUINEA', 'POI Not Recommended'),
(2, '172.217.10.74-10.42.0.151-443-32931-6', 'HESTUR, HESTUR', '1.081338131', '-0.12013683', '6', 'K??ppen climate classification; Oceanic climate#Subpolar variety (Cfc); European Summer Time; Faroe Islands; Hestur; Greenwich Mean Time', '1', 'POPULATED PLACES IN THE FAROE ISLANDS', 'POI Not Recommended'),
(3, '10.42.0.211-23.206.162.129-45353-80-6', 'OLD FEDERAL BUILDING (FAIRBANKS, ALASKA)', '1.131724816', '-2.578224612', '7', 'United States Department of the Treasury; Nome, Alaska; Fairbanks, Alaska; George N. Ray; Washington, DC; National Register of Historic Places; National Register of Historic Places listings in Fairbanks North Star Borough, Alaska', '7', 'POST OFFICE BUILDINGS ON THE NATIONAL REGISTER OF HISTORIC PLACES IN ALASKA; BUILDINGS AND STRUCTURES IN FAIRBANKS, ALASKA; ART DECO ARCHITECTURE IN ALASKA; BUILDINGS AND STRUCTURES ON THE NATIONAL REGISTER OF HISTORIC PLACES IN FAIRBANKS NORTH STAR BOROUGH, ALASKA; 1933 ESTABLISHMENTS IN ALASKA; BUILDINGS AND STRUCTURES COMPLETED IN 1933; COURTHOUSES IN ALASKA', 'POI Not Recommended'),
(4, '172.217.12.206-10.42.0.151-443-34824-6', 'SATIARI', '0.610511324', '0.808034114', '13', 'Kermanshah Province; Shiveh Sar Rural District; Romanize; List of countries; Counties of Iran; Paveh County; Bayangan District; Iran Daylight Time; Iran Standard Time; Provinces of Iran; Rural Districts of Iran; Iran; Bakhsh', '1', 'POPULATED PLACES IN PAVEH COUNTY', 'POI Recommended'),
(5, '10.42.0.211-106.39.162.36-60704-80-6', 'PATAPSCO FEMALE INSTITUTE', '0.685400494', '-1.340359536', '16', 'List of Howard County properties in the Maryland Historical Trust; Union (American Civil War); Thomas Beale Dorsey; finishing school; American Civil War; United States; Baltimore Sun; Baltimore & Ohio Railroad; Normal school; Robert Cary Long, Jr.; Ellicott City, Maryland; Almira Hart Lincoln Phelps', '12', '1837 ESTABLISHMENTS IN MARYLAND; HOWARD COUNTY, MARYLAND LANDMARKS; HISTORY OF WOMEN IN MARYLAND; 1891 DISESTABLISHMENTS IN MARYLAND; HISTORIC DISTRICT CONTRIBUTING PROPERTIES IN MARYLAND; NATIONAL REGISTER OF HISTORIC PLACES IN HOWARD COUNTY, MARYLAND; TOURIST ATTRACTIONS IN HOWARD COUNTY, MARYLAND; SCHOOL BUILDINGS COMPLETED IN 1837; UNIVERSITY AND COLLEGE BUILDINGS ON THE NATIONAL REGISTER OF HISTORIC PLACES IN NEW JERSEY; EDUCATIONAL INSTITUTIONS ESTABLISHED IN 1837; EDUCATIONAL INSTITUTIONS DISESTABLISHED IN 1891; BUILDINGS AND STRUCTURES IN ELLICOTT CITY, MARYLAND', 'POI Recommended');
