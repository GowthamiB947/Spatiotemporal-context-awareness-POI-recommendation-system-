"""a_learning_based_poi_recommendation URL Configuration
...
from a_learning_based_poi_recommendation import settings
...
urlpatterns = [
    ...
    url(r'^Predict_POI_Recommendation/$', remoteuser.Predict_POI_Recommendation, name="Predict_POI_Recommendation"),
    ...
    url(r'^View_POI_Recommendation_Ratio/$', serviceprovider.View_POI_Recommendation_Ratio, name="View_POI_Recommendation_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Prediction_Of_POI_Recommendation/$', serviceprovider.View_Prediction_Of_POI_Recommendation, name="View_Prediction_Of_POI_Recommendation"),
