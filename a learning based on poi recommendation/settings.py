...
ROOT_URLCONF = 'a_learning_based_poi_recommendation.urls'
...
WSGI_APPLICATION = 'a_learning_based_poi_recommendation.wsgi.application'
...
DATABASES = {
    'default': {
        ...
        'NAME': 'a_learning_based_poi_recommendation',
        'USER':'root',
        'PASSWORD': '',
        'HOST' :'127.0.0.1',
        'PORT' :'3306',
